...
awRegex.altitudeNonCapturingGroup = function(whitespaceChar) {
...
// When grouped with the rest of the coordinate, it must be preceded by a whitespace.
awRegex.directionNonCapturingGroup = function(whitespaceChar) {
...
awRegex.buildAwCoordinateRegex = function(whitespaceChar) {
    return awRegex.worldname + 
           ...
           whitespaceChar +
           awRegex.ewposition +
           awRegex.altitudeNonCapturingGroup(whitespaceChar) +
           awRegex.directionNonCapturingGroup(whitespaceChar);
}                          
