...
awLocation.buildAwLocation = function(coordinateParts) {
    ...
    buildYaw(location, coordinateParts[5]);
    buildPitch(location);
    buildRoll(location);
...
awLocation.buildCoordinatesString = function(location, whitespaceChar) {
    return location.worldname + whitespaceChar + 
        location.stringParts.nsposition + whitespaceChar +
        location.stringParts.ewposition + whitespaceChar + 
        location.stringParts.altitude + whitespaceChar +
